...
const SidebarButton: React.FC<SidebarButtonProps> = ({
  ...
  <button
    ...
    className={`group relative w-full flex items-center px-4 py-2.5 rounded-md transition-colors duration-300 ease-in-out
      ${
        isActive
          ? "bg-customRed dark:bg-rose-600 text-white font-medium shadow-sm hover:bg-red-400 dark:hover:bg-rose-700 focus:outline-none  focus:ring-rose-200 dark:focus:ring-rose-800"
