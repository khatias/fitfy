...
import VintageProductCard from "../products/VintageProduct";
function Content() {
  ...
  return (
    <div className="max-w-[1300px] m-auto">
      ...
      <section className="mt-20 mb-20 mx-auto px-6 lg:px-0 ">
        <h2 className="text-2xl font-medium mb-4 dark:text-white">
          {" "}
          <Link href="/products">{t("VintageTitle")}</Link>{" "}
        </h2>
        <p></p>
        <VintageProductCard />
      </section>

      <section className="pt-10 px-6 lg:px-0 mb-40 ">
        <h2 className="text-2xl font-medium mb-4 dark:text-yellow-400">
          <Link href="/blog"> {t("blogsTitle")}</Link>
        </h2>
        <BlogsLanding />
      </section>
    </div>
